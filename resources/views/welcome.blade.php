...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="test" style="display:flex; justify-content:space-around; flex-wrap: wrap; padding: 1.2em;">
        @foreach ($links as $link)
        <div style="border: 1px solid black; width: 20%; height:auto; padding:.6em;">
